...
@Composable
fun CardResetName(ID:String,medicalb:Boolean,
                  BackMedical:()->Unit,
                  BackPatient: () -> Unit,
            ...
            Row(modifier = Modifier
                ...
                Button(onClick = {
                    if (medicalb){
                        ...
                        medicalViewModel.uploadMedical(Medical(medical._id,name,medical.dni,medical.phone,medical.profession,medical.email,medical.direction,medical.tuition,medical.img,medical.token_not,medical.hour_on))
                        BackMedical.invoke()
                    }else{

                        patientViewModel.uploadPatient(Patient(patient._id,name,patient.dni,patient.phone,patient.email,patient.direction,patient.img,patient.token_not))
                        BackPatient.invoke()
                    }
                }) {
