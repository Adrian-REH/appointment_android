...
@Composable
fun CardResetProfession(ID:String,
                        BackMedical:()->Unit,
    ...
    Card(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Row(modifier = Modifier.fillMaxWidth().padding(horizontal = 20.dp).size(25.dp), verticalAlignment = Alignment.CenterVertically) {
                Icon( painterResource(id = R.drawable.ic_briefcase), contentDescription ="" , modifier = Modifier.size(30.dp), tint = Color.Gray)
                Spacers()
            ...
            Row(modifier = Modifier
                ...
                Button(onClick = {
                    ...
                    medicalViewModel.uploadMedical(Medical(medical._id,medical.name_last,medical.dni,medical.phone,profession,medical.email,medical.direction,medical.tuition,medical.img,medical.token_not,medical.hour_on))
                    BackMedical.invoke()
