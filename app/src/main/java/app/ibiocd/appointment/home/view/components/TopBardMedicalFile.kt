...
@Composable
fun TabsMedical(pagerState: PagerState, viewModel: UserViewModel = hiltViewModel()) {

    val list = listOf("Historial", "Estudio","Lab","Receta","Odonto","Forms")
    val lists = listOf(
        ...
        painterResource(id = R.drawable.ic_tooth),
        painterResource(id = R.drawable.ic_user_edit)
