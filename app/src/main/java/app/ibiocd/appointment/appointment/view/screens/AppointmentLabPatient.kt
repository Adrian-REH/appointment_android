...
fun AppointmentLabPatient(
    ...
    medicalname= lablist.find { it._id.contentEquals(AppointmentItem.medical) }?.name_lab ?:""
        ...
        .background(Color.White))
    {
        ...
        item {
            Column(modifier = Modifier
                ...
                CardFile("Stady",FileItem.stadies,false, onDownload = {
                ...
                Spacers()
                CardFile("Laboratory",FileItem.laboratory,false, onDownload = {
                    onDownload.invoke(it)
